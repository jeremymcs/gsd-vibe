...
// ============================================================
// M011 — Preferences Editor types and invoke wrappers
// ============================================================

export interface PreferencesHookEntry {
  name: string;
  // post_unit_hooks fields
  after?: string[];
  prompt?: string;
  max_cycles?: number;
  model?: string;
...
export const gsd2GetPreferences = (projectId: string) =>
  invoke<PreferencesData>('gsd2_get_preferences', { projectId });

export const gsd2SavePreferences = (
  projectId: string,
  scope: 'global' | 'project',
  payload: Record<string, unknown>,
) => invoke<void>('gsd2_save_preferences', { projectId, scope, payload });

export const gsd2GetGlobalPreferences = () =>
  invoke<PreferencesData>('gsd2_get_global_preferences');

export const gsd2SaveGlobalPreferences = (payload: Record<string, unknown>) =>
  invoke<void>('gsd2_save_global_preferences', { payload });

export interface GsdModelEntry {
  provider: string;
  id: string;
  name: string;
}
...
export const gsd2CleanWorktrees = (projectId: string) =>
  invoke<string>('gsd2_clean_worktrees', { projectId });
...
export const githubCreatePr = (projectPath: string, title: string, body: string, head: string, base: string, draft: boolean) =>
...
export const githubCreateIssue = (projectPath: string, title: string, body: string, labels: string[], assignees: string[]) =>
